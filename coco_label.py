...
dataType = 'val2014'  # 要转换的COCO数据集的子集名
...
list_file = open('%s/filelist/%s_41.txt' % (dataDir, dataType), 'w')  # 数据集的图片list保存路径
...
for imgId in imgIds:
    ...
    # anns = coco.getAnns(imgIds=imgId, catIds=catIds, iscrowd=None)
